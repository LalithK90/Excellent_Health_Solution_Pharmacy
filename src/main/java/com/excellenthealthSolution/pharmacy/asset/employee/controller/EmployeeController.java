...
public class EmployeeController {
    ...
    public EmployeeController(EmployeeService employeeService, UserService userService,
                              DateTimeAgeService dateTimeAgeService, EmailService emailService) {
    ...
    public String addEmployee(@Valid @ModelAttribute Employee employee, BindingResult result, Model model,
        ...
        if ( employee.getId() != null ) {
            ...
            String message = "Welcome to Excellent Health Solution \n " +
                    ...
                    "\n\n\n\n\n Highly advice you, if there is any changes on your details, Please informed the " +
                    "management" +
                    "\n If you update your date up to date with us, otherwise we will not have to provide better " +
                    "service to you." +
                    "\n \n \n   Thank You" +
                    "\n Excellent Health Solution";
            boolean isFlag = emailService.sendPatientRegistrationEmail(employee.getEmail(), "Welcome to Excellent " +
                    "Health Solution ", message);
            if ( isFlag ) {
